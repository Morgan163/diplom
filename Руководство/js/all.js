...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Работа с топологиями","2. Моделирование","Раздел без номера"],
    DREX_NODE_LINKS: ["index.htm","rabota_s_topologiyami.htm","modelirovanie.htm","razdel_bez_nomera.htm"],
    DREX_NODE_CHILD_START: [1,4,4,4],
    DREX_NODE_CHILD_END: [4,4,4,4],
    DREX_MENU_TYPE: 2,
